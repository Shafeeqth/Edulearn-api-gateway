...
export const NotificationServiceService = {
  ...
  getANotification: {
    ...
    responseSerialize: (value: GetNotificationResponse) => Buffer.from(GetNotificationResponse.encode(value).finish()),
...
export interface NotificationServiceServer extends UntypedServiceImplementation {
  ...
  getANotification: handleUnaryCall<GetNotificationRequest, GetNotificationResponse>;
